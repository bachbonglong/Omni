...
class StatusOrder extends StatefulWidget {
  StatusOrder({Key key}) : super(key: key);

  @override
  _StatusOrder createState() => _StatusOrder();
}

class _StatusOrder extends State<StatusOrder> {
  @override
  void initState() {
    super.initState();
  }
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text("Chuyển Khoản", style: TextStyle(fontSize: 20,fontWeight: FontWeight.w300)),
                Row(
                  children: <Widget>[
                    Icon(
                      Icons.arrow_forward_ios,
    ...
    return Center(
      child: new Container(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, Constants.statusorderDuyet);
          },
          child: Container(
            width: (136),
            height: (50),
