...
class StateOrderXuatKho extends StatefulWidget {
  StateOrderXuatKho({Key key}) : super(key: key);

  @override
  _StateOrderXuatKho createState() => _StateOrderXuatKho();
}

class _StateOrderXuatKho extends State<StateOrderXuatKho> {
  @override
  void initState() {
    super.initState();
  }
...
class ButtonSubmit3 extends StatelessWidget {
  const ButtonSubmit3({
    Key key,
  }) : super(key: key);
    ...
    return Center(
      child: new Container(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, Constants.statusorderHoanthanh);
          },
          child: Container(
            width: (136),
            height: (50),
