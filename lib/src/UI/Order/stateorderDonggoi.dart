...
class StateOrderDongGoi extends StatefulWidget {
  StateOrderDongGoi({Key key}) : super(key: key);

  @override
  _StateOrderDongGoi createState() => _StateOrderDongGoi();
}

class _StateOrderDongGoi extends State<StateOrderDongGoi> {
  @override
  void initState() {
    super.initState();
  }
...
class ButtonSubmit2 extends StatelessWidget {
  const ButtonSubmit2({
    Key key,
  }) : super(key: key);
    ...
    return Center(
      child: new Container(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, Constants.statusorderXuatkho);
          },
          child: Container(
            width: (136),
            height: (50),
