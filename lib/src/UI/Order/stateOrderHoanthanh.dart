...
class StateOrderHoanThanh extends StatefulWidget {
  StateOrderHoanThanh({Key key}) : super(key: key);

  @override
  _StateOrderHoanThanh createState() => _StateOrderHoanThanh();
}

class _StateOrderHoanThanh extends State<StateOrderHoanThanh> {
  @override
  void initState() {
    super.initState();
  }
...
class ButtonSubmit4 extends StatelessWidget {
  const ButtonSubmit4({
    Key key,
  }) : super(key: key);
