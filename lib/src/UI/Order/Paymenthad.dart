...
class PaymentHad extends StatefulWidget {
  PaymentHad({Key key}) : super(key: key);

  @override
  _Paymenthad createState() => _Paymenthad();
}

class _Paymenthad extends State<PaymentHad> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return Center(
      child: new Container(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, Constants.statusorder);
          },
          child: Container(
            width: (136),
            height: (50),
