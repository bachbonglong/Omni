        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            new Expanded(child: Container()),
              new Text(
                "Áo TeenWorld",
                style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400, color: Color(0xff716767), ),
              ),
            new Expanded(child: Container()),
            new Icon(Icons.arrow_forward_ios,color: Colors.black26,)
          ],
        ), 
      ),
    );
          ...
          Expanded(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                ...
                iconSize: 24,
                style: TextStyle(color: Color(0xff716767),),
