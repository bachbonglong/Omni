...
class StateWareHouseHoanThanh extends StatefulWidget {
  StateWareHouseHoanThanh({Key key}) : super(key: key);

  @override
  _StateWareHouseHoanThanh createState() => _StateWareHouseHoanThanh();
}

class _StateWareHouseHoanThanh extends State<StateWareHouseHoanThanh> {
  @override
  void initState() {
    super.initState();
  }
