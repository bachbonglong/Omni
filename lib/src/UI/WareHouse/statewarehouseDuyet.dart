...
class StateWareHouseDuyet extends StatefulWidget {
  StateWareHouseDuyet({Key key}) : super(key: key);

  @override
  _StateWareHouseDuyet createState() => _StateWareHouseDuyet();
}

class _StateWareHouseDuyet extends State<StateWareHouseDuyet> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return Center(
      child: new Container(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, Constants.statewarehouseNhapKho);
          },
          child: Container(
            width: (136),
            height: (50),
