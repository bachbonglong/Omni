...
class AddProductWareHouse extends StatefulWidget {
  AddProductWareHouse({Key key}) : super(key: key);

  @override
  _AddProductWareHouse createState() => _AddProductWareHouse();
}

class _AddProductWareHouse extends State<AddProductWareHouse>
    ...
    return Center(
      child: new Container(
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, Constants.addproductwarehousehad);
          },
          child: Container(
            width: (136),
            height: (50),
