...
class PaymentWareHouse extends StatefulWidget {
  PaymentWareHouse({Key key}) : super(key: key);

  @override
  _PaymentWareHouse createState() => _PaymentWareHouse();
}

class _PaymentWareHouse extends State<PaymentWareHouse> with SingleTickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
  }
                                                ...
                                                Container(
                                                  ...
                                                  child: InkWell(
                                                    onTap: () {
                                                      Navigator.pushNamed(
                                                          context,
                                                         Constants.statewarehouseHoanThanh);
                                                    },
                                                    child: Container(
                                                      padding: EdgeInsets.only(
                                                        top: 20.0,
